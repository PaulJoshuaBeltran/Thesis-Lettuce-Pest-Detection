...
public class cameraexclass extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "thesishydroponicsv5.pushexample.cameraexclass");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", thesishydroponicsv5.pushexample.cameraexclass.class).invoke(this, new Object[] {null});
        else
...
public String  _camera_focusdone(boolean _success) throws Exception{
 //BA.debugLineNum = 321;BA.debugLine="Private Sub Camera_FocusDone (Success As Boolean)";
 //BA.debugLineNum = 322;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 323;BA.debugLine="TakePicture";
_takepicture();
 }else {
 //BA.debugLineNum = 325;BA.debugLine="Log(\"AutoFocus error.\")";
__c.LogImpl("13997700","AutoFocus error.",0);
 };
...
__c.LogImpl("11703944","success = false, "+BA.ObjectToString(__c.LastException(ba)),0);
 };
...
public String  _closenow() throws Exception{
 //BA.debugLineNum = 311;BA.debugLine="Public Sub CloseNow";
 //BA.debugLineNum = 312;BA.debugLine="cam.Release";
_cam.Release();
 //BA.debugLineNum = 313;BA.debugLine="r.target = cam";
_r.Target = (Object)(_cam);
 //BA.debugLineNum = 314;BA.debugLine="r.RunMethod2(\"releaseCameras\", True, \"java.lang.b";
...
public String  _commitparameters() throws Exception{
 ...
 //BA.debugLineNum = 144;BA.debugLine="r.target = nativeCam";
_r.Target = _nativecam;
 //BA.debugLineNum = 145;BA.debugLine="r.RunMethod4(\"setParameters\", Array As Object(par";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper _facerect = null;
 //BA.debugLineNum = 375;BA.debugLine="Private Sub FaceDetection_Event (MethodName As Str";
 //BA.debugLineNum = 376;BA.debugLine="Dim faces() As Object = Args(0)";
_faces = (Object[])(_args[(int) (0)]);
 //BA.debugLineNum = 377;BA.debugLine="For Each f As Object In faces";
{
...
_f = group2[index2];
 //BA.debugLineNum = 378;BA.debugLine="Dim jo As JavaObject = f";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_f));
 //BA.debugLineNum = 379;BA.debugLine="Dim faceRect As Rect = jo.GetField(\"rect\")";
...
_facerect = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper(), (android.graphics.Rect)(_jo.GetField("rect")));
 //BA.debugLineNum = 380;BA.debugLine="Log(faceRect)";
__c.LogImpl("14653061",BA.ObjectToString(_facerect),0);
 }
};
 //BA.debugLineNum = 382;BA.debugLine="Return Null";
if (true) return __c.Null;
 //BA.debugLineNum = 383;BA.debugLine="End Sub";
return null;
}
public thesishydroponicsv5.pushexample.cameraexclass._camerainfoandid  _findcamera(boolean _frontcamera) throws Exception{
thesishydroponicsv5.pushexample.cameraexclass._camerainfoandid _ci = null;
...
_ci = new thesishydroponicsv5.pushexample.cameraexclass._camerainfoandid();
...
__c.LogImpl("11572868","findCamera",0);
...
__c.LogImpl("11572872",BA.ObjectToString(_r.Target),0);
 //BA.debugLineNum = 44;BA.debugLine="Log(numberOfCameras)";
__c.LogImpl("11572873",BA.NumberToString(_numberofcameras),0);
...
__c.LogImpl("11572878","facing: "+BA.ObjectToString(_r.GetField("facing"))+", "+BA.NumberToString(_cameravalue),0);
...
public String  _focusandtakepicture() throws Exception{
 //BA.debugLineNum = 317;BA.debugLine="Public Sub FocusAndTakePicture";
 //BA.debugLineNum = 318;BA.debugLine="cam.AutoFocus";
_cam.AutoFocus();
 //BA.debugLineNum = 319;BA.debugLine="End Sub";
return "";
}
public String  _getcoloreffect() throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Public Sub GetColorEffect As String";
 //BA.debugLineNum = 153;BA.debugLine="Return GetParameter(\"effect\")";
if (true) return _getparameter("effect");
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public int  _getexposurecompensation() throws Exception{
 //BA.debugLineNum = 349;BA.debugLine="Public Sub getExposureCompensation As Int";
 //BA.debugLineNum = 350;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 351;BA.debugLine="Return r.RunMethod(\"getExposureCompensation\")";
...
public String  _getflashmode() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Public Sub GetFlashMode As String";
 //BA.debugLineNum = 204;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 205;BA.debugLine="Return r.RunMethod(\"getFlashMode\")";
...
float[] _f = null;
 //BA.debugLineNum = 298;BA.debugLine="Public Sub GetFocusDistances As Float()";
 //BA.debugLineNum = 299;BA.debugLine="Dim F(3) As Float";
_f = new float[(int) (3)];
;
 //BA.debugLineNum = 300;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 301;BA.debugLine="r.RunMethod4(\"getFocusDistances\", Array As Object";
_r.RunMethod4("getFocusDistances",new Object[]{(Object)(_f)},new String[]{"[F"});
 //BA.debugLineNum = 302;BA.debugLine="Return F";
if (true) return _f;
 //BA.debugLineNum = 303;BA.debugLine="End Sub";
return null;
}
public int  _getmaxexposurecompensation() throws Exception{
 //BA.debugLineNum = 364;BA.debugLine="Public Sub getMaxExposureCompensation As Int";
 //BA.debugLineNum = 365;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 366;BA.debugLine="Return r.RunMethod(\"getMaxExposureCompensation\")";
...
public int  _getmaxzoom() throws Exception{
 //BA.debugLineNum = 334;BA.debugLine="Public Sub GetMaxZoom As Int";
 //BA.debugLineNum = 335;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 336;BA.debugLine="Return r.RunMethod(\"getMaxZoom\")";
...
public int  _getminexposurecompensation() throws Exception{
 //BA.debugLineNum = 359;BA.debugLine="Public Sub getMinExposureCompensation As Int";
 //BA.debugLineNum = 360;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 361;BA.debugLine="Return r.RunMethod(\"getMinExposureCompensation\")";
...
public String  _getparameter(String _key) throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Public Sub GetParameter(Key As String) As String";
 //BA.debugLineNum = 138;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 139;BA.debugLine="Return r.RunMethod2(\"get\", Key, \"java.lang.String";
if (true) return BA.ObjectToString(_r.RunMethod2("get",_key,"java.lang.String"));
 //BA.debugLineNum = 140;BA.debugLine="End Sub";
return "";
}
public thesishydroponicsv5.pushexample.cameraexclass._camerasize  _getpicturesize() throws Exception{
thesishydroponicsv5.pushexample.cameraexclass._camerasize _cs = null;
 //BA.debugLineNum = 245;BA.debugLine="Public Sub GetPictureSize As CameraSize";
 //BA.debugLineNum = 246;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 247;BA.debugLine="r.target = r.RunMethod(\"getPictureSize\")";
_r.Target = _r.RunMethod("getPictureSize");
 //BA.debugLineNum = 248;BA.debugLine="Dim cs As CameraSize";
_cs = new thesishydroponicsv5.pushexample.cameraexclass._camerasize();
 //BA.debugLineNum = 249;BA.debugLine="cs.Width = r.GetField(\"width\")";
_cs.Width /*int*/  = (int)(BA.ObjectToNumber(_r.GetField("width")));
 //BA.debugLineNum = 250;BA.debugLine="cs.Height = r.GetField(\"height\")";
_cs.Height /*int*/  = (int)(BA.ObjectToNumber(_r.GetField("height")));
 //BA.debugLineNum = 251;BA.debugLine="Return cs";
if (true) return _cs;
 //BA.debugLineNum = 252;BA.debugLine="End Sub";
return null;
}
public String  _getpreviewfpsrange(int[] _range) throws Exception{
 //BA.debugLineNum = 225;BA.debugLine="Public Sub GetPreviewFpsRange(Range() As Int)";
 //BA.debugLineNum = 226;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 227;BA.debugLine="r.RunMethod4(\"getPreviewFpsRange\", Array As Objec";
_r.RunMethod4("getPreviewFpsRange",new Object[]{(Object)(_range)},new String[]{"[I"});
 //BA.debugLineNum = 228;BA.debugLine="End Sub";
return "";
}
public thesishydroponicsv5.pushexample.cameraexclass._camerasize  _getpreviewsize() throws Exception{
thesishydroponicsv5.pushexample.cameraexclass._camerasize _cs = null;
 //BA.debugLineNum = 236;BA.debugLine="Public Sub GetPreviewSize As CameraSize";
 //BA.debugLineNum = 237;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 238;BA.debugLine="r.target = r.RunMethod(\"getPreviewSize\")";
_r.Target = _r.RunMethod("getPreviewSize");
 //BA.debugLineNum = 239;BA.debugLine="Dim cs As CameraSize";
_cs = new thesishydroponicsv5.pushexample.cameraexclass._camerasize();
 //BA.debugLineNum = 240;BA.debugLine="cs.Width = r.GetField(\"width\")";
_cs.Width /*int*/  = (int)(BA.ObjectToNumber(_r.GetField("width")));
 //BA.debugLineNum = 241;BA.debugLine="cs.Height = r.GetField(\"height\")";
_cs.Height /*int*/  = (int)(BA.ObjectToNumber(_r.GetField("height")));
 //BA.debugLineNum = 242;BA.debugLine="Return cs";
if (true) return _cs;
 //BA.debugLineNum = 243;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.collections.List  _getsupportedcoloreffects() throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Public Sub GetSupportedColorEffects As List";
 //BA.debugLineNum = 214;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 215;BA.debugLine="Return r.RunMethod(\"getSupportedColorEffects\")";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedflashmodes() throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Public Sub GetSupportedFlashModes As List";
 //BA.debugLineNum = 209;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 210;BA.debugLine="Return r.RunMethod(\"getSupportedFlashModes\")";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedfocusmodes() throws Exception{
 //BA.debugLineNum = 277;BA.debugLine="Public Sub GetSupportedFocusModes As List";
 //BA.debugLineNum = 278;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 279;BA.debugLine="Return r.RunMethod(\"getSupportedFocusModes\")";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedpictureformats() throws Exception{
 //BA.debugLineNum = 305;BA.debugLine="Public Sub GetSupportedPictureFormats As List";
 //BA.debugLineNum = 306;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 307;BA.debugLine="Return r.RunMethod(\"getSupportedPictureFormats\")";
...
public thesishydroponicsv5.pushexample.cameraexclass._camerasize[]  _getsupportedpicturessizes() throws Exception{
anywheresoftware.b4a.objects.collections.List _list1 = null;
thesishydroponicsv5.pushexample.cameraexclass._camerasize[] _cs = null;
int _i = 0;
 //BA.debugLineNum = 176;BA.debugLine="Public Sub GetSupportedPicturesSizes As CameraSize";
 //BA.debugLineNum = 177;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 178;BA.debugLine="Dim list1 As List = r.RunMethod(\"getSupportedPict";
...
_list1 = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_r.RunMethod("getSupportedPictureSizes")));
 //BA.debugLineNum = 179;BA.debugLine="Dim cs(list1.Size) As CameraSize";
_cs = new thesishydroponicsv5.pushexample.cameraexclass._camerasize[_list1.getSize()];
{
int d0 = _cs.length;
for (int i0 = 0;i0 < d0;i0++) {
_cs[i0] = new thesishydroponicsv5.pushexample.cameraexclass._camerasize();
}
}
;
 //BA.debugLineNum = 180;BA.debugLine="For i = 0 To list1.Size - 1";
{
final int step4 = 1;
final int limit4 = (int) (_list1.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit4 ;_i = _i + step4 ) {
 //BA.debugLineNum = 181;BA.debugLine="r.target = list1.get(i)";
_r.Target = _list1.Get(_i);
 //BA.debugLineNum = 182;BA.debugLine="cs(i).Width = r.GetField(\"width\")";
_cs[_i].Width /*int*/  = (int)(BA.ObjectToNumber(_r.GetField("width")));
 //BA.debugLineNum = 183;BA.debugLine="cs(i).Height = r.GetField(\"height\")";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedpreviewfpsrange() throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Public Sub GetSupportedPreviewFpsRange As List";
 //BA.debugLineNum = 220;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 221;BA.debugLine="Return r.RunMethod(\"getSupportedPreviewFpsRange\")";
...
public thesishydroponicsv5.pushexample.cameraexclass._camerasize[]  _getsupportedpreviewsizes() throws Exception{
anywheresoftware.b4a.objects.collections.List _list1 = null;
thesishydroponicsv5.pushexample.cameraexclass._camerasize[] _cs = null;
int _i = 0;
 //BA.debugLineNum = 160;BA.debugLine="Public Sub GetSupportedPreviewSizes As CameraSize(";
 //BA.debugLineNum = 161;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 162;BA.debugLine="Dim list1 As List = r.RunMethod(\"getSupportedPrev";
_list1 = new anywheresoftware.b4a.objects.collections.List();
_list1 = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_r.RunMethod("getSupportedPreviewSizes")));
 //BA.debugLineNum = 163;BA.debugLine="Dim cs(list1.Size) As CameraSize";
_cs = new thesishydroponicsv5.pushexample.cameraexclass._camerasize[_list1.getSize()];
{
int d0 = _cs.length;
for (int i0 = 0;i0 < d0;i0++) {
...
;
 //BA.debugLineNum = 164;BA.debugLine="For i = 0 To list1.Size - 1";
{
final int step4 = 1;
final int limit4 = (int) (_list1.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit4 ;_i = _i + step4 ) {
 //BA.debugLineNum = 165;BA.debugLine="r.target = list1.get(i)";
_r.Target = _list1.Get(_i);
 //BA.debugLineNum = 166;BA.debugLine="cs(i).Width = r.GetField(\"width\")";
_cs[_i].Width /*int*/  = (int)(BA.ObjectToNumber(_r.GetField("width")));
 //BA.debugLineNum = 167;BA.debugLine="cs(i).Height = r.GetField(\"height\")";
_cs[_i].Height /*int*/  = (int)(BA.ObjectToNumber(_r.GetField("height")));
 }
};
 //BA.debugLineNum = 169;BA.debugLine="Return cs";
if (true) return _cs;
 //BA.debugLineNum = 170;BA.debugLine="End Sub";
return null;
}
public int  _getzoom() throws Exception{
 //BA.debugLineNum = 339;BA.debugLine="Public Sub getZoom() As Int";
 //BA.debugLineNum = 340;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 341;BA.debugLine="Return r.RunMethod(\"getZoom\")";
...
public boolean  _iszoomsupported() throws Exception{
 //BA.debugLineNum = 329;BA.debugLine="Public Sub IsZoomSupported As Boolean";
 //BA.debugLineNum = 330;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 331;BA.debugLine="Return r.RunMethod(\"isZoomSupported\")";
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 256;BA.debugLine="Public Sub PreviewImageToJpeg(data() As Byte, qual";
 //BA.debugLineNum = 257;BA.debugLine="Dim size, previewFormat As Object";
_size = new Object();
_previewformat = new Object();
 //BA.debugLineNum = 258;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 259;BA.debugLine="size = r.RunMethod(\"getPreviewSize\")";
_size = _r.RunMethod("getPreviewSize");
 //BA.debugLineNum = 260;BA.debugLine="previewFormat = r.RunMethod(\"getPreviewFormat\")";
_previewformat = _r.RunMethod("getPreviewFormat");
 //BA.debugLineNum = 261;BA.debugLine="r.target = size";
_r.Target = _size;
 //BA.debugLineNum = 262;BA.debugLine="Dim width = r.GetField(\"width\"), height = r.GetFi";
_width = (int)(BA.ObjectToNumber(_r.GetField("width")));
_height = (int)(BA.ObjectToNumber(_r.GetField("height")));
 //BA.debugLineNum = 263;BA.debugLine="Dim yuvImage As Object = r.CreateObject2(\"android";
_yuvimage = _r.CreateObject2("android.graphics.YuvImage",new Object[]{(Object)(_data),_previewformat,(Object)(_width),(Object)(_height),__c.Null},new String[]{"[B","java.lang.int","java.lang.int","java.lang.int","[I"});
 //BA.debugLineNum = 266;BA.debugLine="r.target = yuvImage";
_r.Target = _yuvimage;
 //BA.debugLineNum = 267;BA.debugLine="Dim rect1 As Rect";
_rect1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 268;BA.debugLine="rect1.Initialize(0, 0, r.RunMethod(\"getWidth\"), r";
_rect1.Initialize((int) (0),(int) (0),(int)(BA.ObjectToNumber(_r.RunMethod("getWidth"))),(int)(BA.ObjectToNumber(_r.RunMethod("getHeight"))));
 //BA.debugLineNum = 269;BA.debugLine="Dim out As OutputStream";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 270;BA.debugLine="out.InitializeToBytesArray(100)";
_out.InitializeToBytesArray((int) (100));
 //BA.debugLineNum = 271;BA.debugLine="r.RunMethod4(\"compressToJpeg\", Array As Object(re";
_r.RunMethod4("compressToJpeg",new Object[]{(Object)(_rect1.getObject()),(Object)(_quality),(Object)(_out.getObject())},new String[]{"android.graphics.Rect","java.lang.int","java.io.OutputStream"});
 //BA.debugLineNum = 274;BA.debugLine="Return out.ToBytesArray";
...
public String  _setcoloreffect(String _effect) throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Public Sub SetColorEffect(Effect As String)";
 //BA.debugLineNum = 157;BA.debugLine="SetParameter(\"effect\", Effect)";
...
anywheresoftware.b4a.objects.collections.List _modes = null;
 //BA.debugLineNum = 282;BA.debugLine="Public Sub SetContinuousAutoFocus";
 //BA.debugLineNum = 283;BA.debugLine="Dim modes As List = GetSupportedFocusModes";
_modes = new anywheresoftware.b4a.objects.collections.List();
_modes = _getsupportedfocusmodes();
 //BA.debugLineNum = 284;BA.debugLine="If modes.IndexOf(\"continuous-picture\") > -1 Then";
if (_modes.IndexOf((Object)("continuous-picture"))>-1) { 
 //BA.debugLineNum = 285;BA.debugLine="SetFocusMode(\"continuous-picture\")";
_setfocusmode("continuous-picture");
 }else if(_modes.IndexOf((Object)("continuous-video"))>-1) { 
 //BA.debugLineNum = 287;BA.debugLine="SetFocusMode(\"continuous-video\")";
_setfocusmode("continuous-video");
 }else {
 //BA.debugLineNum = 289;BA.debugLine="Log(\"Continuous focus mode is not available\")";
__c.LogImpl("13604487","Continuous focus mode is not available",0);
 };
...
_r.Target = _nativecam;
 //BA.debugLineNum = 80;BA.debugLine="r.RunMethod2(\"setDisplayOrientation\", previewResu";
...
public String  _setexposurecompensation(int _v) throws Exception{
 //BA.debugLineNum = 354;BA.debugLine="Public Sub setExposureCompensation(v As Int)";
 //BA.debugLineNum = 355;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 356;BA.debugLine="r.RunMethod2(\"setExposureCompensation\", v, \"java.";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
Object _e = null;
 //BA.debugLineNum = 369;BA.debugLine="Public Sub SetFaceDetectionListener";
 //BA.debugLineNum = 370;BA.debugLine="Dim jo As JavaObject = nativeCam";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_nativecam));
 //BA.debugLineNum = 371;BA.debugLine="Dim e As Object = jo.CreateEvent(\"android.hardwar";
_e = _jo.CreateEvent(ba,"android.hardware.Camera.FaceDetectionListener","FaceDetection",__c.Null);
 //BA.debugLineNum = 372;BA.debugLine="jo.RunMethod(\"setFaceDetectionListener\", Array(e)";
_jo.RunMethod("setFaceDetectionListener",new Object[]{_e});
 //BA.debugLineNum = 373;BA.debugLine="End Sub";
return "";
}
public String  _setflashmode(String _mode) throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Public Sub SetFlashMode(Mode As String)";
 //BA.debugLineNum = 199;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 200;BA.debugLine="r.RunMethod2(\"setFlashMode\", Mode, \"java.lang.Str";
_r.RunMethod2("setFlashMode",_mode,"java.lang.String");
 //BA.debugLineNum = 201;BA.debugLine="End Sub";
return "";
}
public String  _setfocusmode(String _mode) throws Exception{
 //BA.debugLineNum = 293;BA.debugLine="Public Sub SetFocusMode(Mode As String)";
 //BA.debugLineNum = 294;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 295;BA.debugLine="r.RunMethod2(\"setFocusMode\", Mode, \"java.lang.Str";
_r.RunMethod2("setFocusMode",_mode,"java.lang.String");
 //BA.debugLineNum = 296;BA.debugLine="End Sub";
return "";
}
public String  _setjpegquality(int _quality) throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Public Sub SetJpegQuality(Quality As Int)";
 //BA.debugLineNum = 194;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 195;BA.debugLine="r.RunMethod2(\"setJpegQuality\", Quality, \"java.lan";
...
public String  _setparameter(String _key,String _value) throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Public Sub SetParameter(Key As String, Value As St";
 //BA.debugLineNum = 133;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 134;BA.debugLine="r.RunMethod3(\"set\", Key, \"java.lang.String\", Valu";
...
public String  _setpicturesize(int _width,int _height) throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Public Sub SetPictureSize(Width As Int, Height As";
 //BA.debugLineNum = 189;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 190;BA.debugLine="r.RunMethod3(\"setPictureSize\", Width, \"java.lang.";
...
public String  _setpreviewfpsrange(int _minvalue,int _maxvalue) throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Public Sub SetPreviewFpsRange(MinValue As Int, Max";
 //BA.debugLineNum = 231;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 232;BA.debugLine="r.RunMethod4(\"setPreviewFpsRange\", Array As Objec";
...
public String  _setpreviewsize(int _width,int _height) throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Public Sub SetPreviewSize(Width As Int, Height As";
 //BA.debugLineNum = 173;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 174;BA.debugLine="r.RunMethod3(\"setPreviewSize\", Width, \"java.lang.";
...
public String  _setzoom(int _zoomvalue) throws Exception{
 //BA.debugLineNum = 344;BA.debugLine="Public Sub setZoom(ZoomValue As Int)";
 //BA.debugLineNum = 345;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 346;BA.debugLine="r.RunMethod2(\"setZoom\", ZoomValue, \"java.lang.int";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 385;BA.debugLine="Public Sub StartFaceDetection";
 //BA.debugLineNum = 386;BA.debugLine="Dim jo As JavaObject = nativeCam";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_nativecam));
 //BA.debugLineNum = 387;BA.debugLine="jo.RunMethod(\"startFaceDetection\", Null)";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 390;BA.debugLine="Public Sub StopFaceDetection";
 //BA.debugLineNum = 391;BA.debugLine="Dim jo As JavaObject = nativeCam";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_nativecam));
 //BA.debugLineNum = 392;BA.debugLine="jo.RunMethod(\"stopFaceDetection\", Null)";
