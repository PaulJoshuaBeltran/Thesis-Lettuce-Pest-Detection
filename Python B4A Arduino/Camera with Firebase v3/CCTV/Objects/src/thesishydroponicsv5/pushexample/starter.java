...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "thesishydroponicsv5.pushexample", "thesishydroponicsv5.pushexample.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "thesishydroponicsv5.pushexample.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static thesishydroponicsv5.pushexample.servermanager _manager = null;
public static String _eol = "";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 7;BA.debugLine="Public manager As ServerManager";
_manager = new thesishydroponicsv5.pushexample.servermanager();
 //BA.debugLineNum = 8;BA.debugLine="Public EOL As String = Chr(13) & Chr(10)";
_eol = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)));
 //BA.debugLineNum = 9;BA.debugLine="Public Phone As Phone";
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 14;BA.debugLine="manager.Initialize(51042)";
_manager._initialize /*String*/ (processBA,(int) (51042));
...
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="CallSubDelayed(FirebaseMessaging, \"SubscribeToTop";
